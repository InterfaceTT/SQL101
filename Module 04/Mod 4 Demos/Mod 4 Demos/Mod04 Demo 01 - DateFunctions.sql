-- MODULE 4 DEMO 1: Date Functions
...
/* A derived table subquery can be used to avoid having to 
repeat the calculation of the Anniversary column, though in 
this case the calculation is simple enough that a derived-
table subquery might be an overkill, but the technique is
useful with more complex calculations. */
...
/* ... and while we're at it, let's format the dates properly
, too. */
...
365.25 to account for leap years. The Floor function truncates the 
