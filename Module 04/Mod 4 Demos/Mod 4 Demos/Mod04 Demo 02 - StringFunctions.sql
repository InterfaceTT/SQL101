/* MODULE 4 DEMO 2: String Functions
...
ARG 3: The number of characters to extract. In the query 
below, the SUBSTRING() function extracts 4 characters
starting at position 4 in the product number.

Here's a query of a sample customer table that extracts
...
SUBSTRING() what the starting position is. */
